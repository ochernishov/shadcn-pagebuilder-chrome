...
- Side-panel capture buttons request the configured HTTP/HTTPS host pattern as an optional Chrome permission only after an explicit click. Chrome users can decline or revoke that access.
